...
filenames <- list.files(here::here("scraper/data-raw/wahis-raw-annual-reports"),
                        pattern = "*.html",
                        full.names = TRUE)
...
toc()
write_rds(wahis_annual, here::here("scraper", "data-intermediate", "wahis_ingested_annual_reports.rds"))

# Transform files   ------------------------------------------------------
annual_reports <-  readr::read_rds(here::here("scraper", "data-intermediate", "wahis_ingested_annual_reports.rds"))
...
toc()
write_rds(annual_reports_transformed, here::here("scraper", "data-intermediate", "wahis_transformed_annual_reports.rds"))

# Save files to db --------------------------------------------------------
annual_reports_transformed <- read_rds(here::here("scraper", "data-intermediate", "wahis_transformed_annual_reports.rds"))
